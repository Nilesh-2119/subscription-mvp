...
export function VendorRegistrationForm() {
    ...
    if (isSuccess) { // Changed 'submitted' to 'isSuccess'
        return (
            <motion.div
            ...
            >
                ...
                <p className="text-green-700 mb-6">
                    Welcome to the Tiffin family. We will review your details and get back to you shortly.
                </p>
    ...
    return (
        <div className="w-full max-w-md mx-auto">
            <h2 className="text-3xl font-extrabold mb-2 text-gray-900">Partner with us</h2>
            <p className="text-gray-500 mb-8">Create your account and start selling today.</p>
